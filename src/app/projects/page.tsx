...
const PROJECTS = [
  {
    id: 1,
    name: "IBIKORANEZA Dieudonne's Blog",
    description: `This is a personal blog website created to share insights, tutorials, and experiences 
          related to software development, technology, and personal growth. Built with a clean, 
          responsive design, the blog features categorized posts, a searchable archive, and 
          a user-friendly interface. Whether you're a developer or a tech enthusiast, you'll find 
          valuable and engaging content regularly updated by IBIKORANEZA Dieudonne.`,
  ...
  },
  {
    ...
    images: [
      "/assets/projects-screenshots/smartparkingassitant/01.jpg",
